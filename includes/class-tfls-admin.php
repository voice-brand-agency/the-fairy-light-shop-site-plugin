		...
		function check_database_file() {
			...
			if ( ! file_exists( TFLS_GEOIP_DB ) ) {
				...
				<div class="update-nag">
					<strong>WooCommerce Product Price Based on Countries</strong> now works with <span
						style="font-style:italic">GeoIP Database</span>, please go to <a
						href="<?php echo self_admin_url( 'admin.php?page=wc-settings&tab=price_based_country' ); ?>">settings
						page</a> to activate.
				</div>
			<?php
			}
